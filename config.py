...
AES_KEY = b'tz$x&SI#23C46Cx@VRgqAi5wDk9JqQLx'  # Должен быть либо 16 бит (символов) либо 32.
AES_NONCE = b'V5c76!YiM#o7S7xbSfrjBRSDd5Eaquvd' # Должен быть либо 16 бит (символов) либо 32.